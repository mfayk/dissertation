...
class RellisDataset(Dataset):
    def __init__(self, root_dir, transform=None):
        self.root_dir = root_dir
        self.transform = transform
        self.image_folder = os.path.join(root_dir, 'rgb')
        self.mask_folder = os.path.join(root_dir, 'id')
    ...
    def __getitem__(self, idx):
        ...
        mask_name = os.path.join(self.mask_folder, self.file_list[idx].replace('.jpg', '_mask.png'))
...
# dataset = RellisDataset(root_dir='/path/to/rellis/dataset', transform=transform)
